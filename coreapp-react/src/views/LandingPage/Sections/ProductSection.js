...
export default function ProductSection() {
    ...
    const filteredCourses = courses.filter(course => course._course_num.toUpperCase().indexOf(searchResults.toUpperCase()) >= 0 || course._course_name.toUpperCase().indexOf(searchResults.toUpperCase()) >=0 || (course._course_name.toUpperCase() + ' ' + course._course_num.toUpperCase()).indexOf(searchResults.toUpperCase()) >= 0 || course._course_description.toUpperCase().indexOf(searchResults.toUpperCase()) >= 0);
