...
review_routes.post('/new', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.postNewReview(params.course_id, params.user_id, params.prof_name, params.review_title, params.review_body, params.rating, params.tags)
...
review_routes.delete('/delete', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.deleteReview(params.review_id)
...
review_routes.post('/edit/review_title', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.editReviewTitle(params.review_id, params.review_title)
...
review_routes.post('/edit/review_body', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.editReviewBody(params.review_id, params.review_body)
...
review_routes.post('/edit/prof_name', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.editProfName(params.review_id, params.prof_name)
...
review_routes.post('/edit/rating', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.editRating(params.review_id, params.rating)
...
review_routes.post('/edit/tags', (req, res) => {
    let params = req.body;
    review_handler.reviewEventOutputStream.editTags(params.review_id, params.tags)
